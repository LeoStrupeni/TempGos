...
<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					if ($auth): ?>
					<button class="btn btn-brand btn-elevate btn-icon-sm" id="btn-Nuevo-InventarioExterno" style="width:150px;" type="button">
	...
	<div class="kt-portlet__body p-1">
		<div class="table-responsive">
			<!--begin: Datatable -->
      		<table class="table table-sm table-hover" id="dt-inventarioExterno">
...
@include('InventarioExterno/modalInventarioExterno')
@include('InventarioExterno/modalHistorialVenta')
@include('InventarioExterno/modalEntregar')

@endsection
@section('ScriptporPagina')
	<script src="{{env('APP_URL')}}/gos/InventarioExterno/ajax-inventario-externo.js"></script>
@endsection
