<div class="modal fade" id="modal-refaccionesOS" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl"  style="max-width: 110rem;" role="document">
        <div class="modal-content">
            <div class="modal-header">
              <div class="container-fluid">
                <h5 class="modal-title" id="exampleModalLabel">Agregar Piezas</h5>
                  <div class="float-right">
                    ...
                    <button type="button" id="" class="btn btn-success  m-2"  onclick="atorizarallrefac({{$os->gos_os_id}});">
                      Autorizar
                    </button>
        ...
        <div class="modal-body">
                  ...
                  <form class="kt-form kt-form--label-right" id="refaccioness_form">
                    @csrf
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-6 col-md-4 col-lg-2">
                        ...
                        <input type="email" class="form-control" name="proveedor_email" id="proveedor_email" value="">
                      </div>
                      <div class="col-6 col-md-4 col-lg-2">
               ...
               <div class="container-fluid overflow-auto" style="max-height: 52rem;">
