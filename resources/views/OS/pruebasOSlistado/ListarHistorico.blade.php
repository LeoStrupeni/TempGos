						...
						<div class="kt-portlet kt-portlet--mobile">
							...
							<div class="kt-portlet__head kt-portlet__head--lg">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title" id="nombreblade">Histórico</h3>
								</div>
										...
										<div class ="row">
											<div class="col col-sm-12 col-md-2">
												<div class="vertical-menu">
													...
													<a class="active" href="/listarhis">Histórico<span class="badge badge-light">{{$cuentahistorico}}</a>
													<a href="/listarcan">Canceladas<span class="badge badge-light">{{$cuentaCanceladas ??''}}</span></a>
												</div>
											</div>
											<div class="col col-sm-12 col-md-10">
												<form action="/listarhis-search" method="POST">
													@CSRF
												...
												<div class="table-responsive table-sm p-1" id="Orden-proceso">
													...
													{!!$paghist!!} Mostrando {{$conteoProc}} registros de un total de {{$totalProc}} registros
