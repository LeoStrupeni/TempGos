										...
										<div class ="row">
											<div class="col col-sm-12 col-md-2">
												<div class="vertical-menu">
													...
													<a class="active"  href="/listarcan">Canceladas<span class="badge badge-light">{{$cuentaCanceladas ??''}}</span></a>
												</div>
											</div>
											<div class="col col-sm-12 col-md-10">
												<form action="/listarcan-search" method="POST">
													@CSRF
												...
												<div class="table-responsive table-sm p-1" id="Orden-proceso">
													...
													{!!$pagcanc!!} Mostrando {{$conteoProc}} registros de un total de {{$totalProc}} registros
