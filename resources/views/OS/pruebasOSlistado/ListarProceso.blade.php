										...
										<div class ="row">
											<div class="col col-sm-12 col-md-2">
												<div class="vertical-menu">
													...
													<a class="active" href="/listaros">En Proceso<span class="badge badge-light">{{$cuentaProces ??''}}</a>
											...
											<div class="col col-sm-12 col-md-10">
												<form action="/listaros-search" method="POST">
													@CSRF
												...
												<div class="table-responsive table-sm p-1" id="Orden-proceso">
													...
													{!!$turco!!} Mostrando {{$conteoProc}} registros de un total de {{$totalProc}} registros
