						...
						<div class="kt-portlet kt-portlet--mobile">
							...
							<div class="kt-portlet__head kt-portlet__head--lg">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title" id="nombreblade">Órdenes Entregadas</h3>
								</div>
										...
										<div class ="row">
											<div class="col col-sm-12 col-md-2">
												<div class="vertical-menu">
													...
													<a href="/listarter">Terminadas<span class="badge badge-light">{{$cuentaTerminadas ??''}}</a>
													<a class="active"  href="/listarent">Entregadas<span class="badge badge-light">{{$cuentaEntregadas ??''}}</span></a>
											...
											<div class="col col-sm-12 col-md-10">
												<form action="/listarent-search" method="POST">
													@CSRF
												...
												<div class="table-responsive table-sm p-1" id="Orden-entregada">
													...
													{!!$pagentr!!} Mostrando {{$conteoProc}} registros de un total de {{$totalProc}} registros
