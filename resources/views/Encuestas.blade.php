        ...
        <div class="kt-portlet">
          <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
              <h3 class="kt-portlet__head-title" id="TitleOrden"><label style="font-weight: bold;" for="">Nombre de Encuesta: </label> {{$encuesta->nombre_encuesta}} <br><label style="font-weight: bold;" for="">Descripción: </label> {{$encuesta->descripcion}} </h3>
             

            </div>
            <div class="kt-portlet__head-toolbar">
              <div class="kt-portlet__head-actions">
                <h5 class="kt-portlet__head-title" id="TitleOrden" style="text-align: right; color: #48465b;">  {{$detaseg->empresa}} <label style="font-weight: bold;" for="">:Aseguradora</label> <br>  {{$encuesta->fecha}} <label style="font-weight: bold;" for="">:Fecha de creación</label></h5>             
              </div>
            </div>
          </div>  
