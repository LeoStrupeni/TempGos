  ...
  <div class="kt-portlet__body p-0">
    ...
    <div class='container-fluid'>
        <div class ='row'>
          ...
          <!--  -->
          <div class='ifram container-fluid col-12 col-sm-9'>
            <div class="card mb-3">
              <div class="card-body">
                <h5 class="card-title" id="eleName">{{ $tittle ?? '' }}</h5>
              </div>
            </div>
            <div class="container-fluid">
              <iframe id="ifrm" style="border: none;" src="{{ $src ?? '' }}#zoom=130" width="100% "height="800px"></iframe>
            </div>
          </div>
        </div>
    </div>
